...
const greeting = {
  ...
  subTitle: emoji(
    "Un apasionado desarrollador de software Full Stack 🚀 con experiencia en la creación de aplicaciones web y móviles con JavaScript / Next.js / React.js / Nodejs / React Native y algunas otras bibliotecas y marcos geniales."
  ),
  resumeLink:

...
import hello from "./assets/lottie/splashAnimation"; // Rename to your file name for custom animation
...
const greeting = {
  ...
  /*resumeLink:
    "https://onedrive.live.com/?cid=72A6317609361DF6&id=72A6317609361DF6%21105&parId=72A6317609361DF6%21103&o=OneUp",*/ // Set to empty to hide the button
...
const socialMediaLinks = {
  ...
  whatsapp: "https://api.whatsapp.com/send?phone=523331308335&text=Hola%20Luis!",
  instagram: "https://www.instagram.com/luis_camposr",
  gmail: "lacamposrz@gmail.com",
  facebook: "https://www.facebook.com/LuisalbertoCamposRz",
...
const educationInfo = {
  ...
  schools: [
    ...
    },
    {
      ...
      logo: require("./assets/images/gaia.jpg"),
      subHeader: "Freelancer by Gaiasoft",
      duration: "Noviembre 2019 - Present",
      desc: "Trabajamos desarrollando ecommerce para clientes que quieren llevar su negoció a la web, así como diferentes aplicaciones web para todos los dispositivos responsives.",
...
const contactInfo = {
  ...
  subtitle:
    "Más Info: 3331308335, Guadalajara, Jalisco, México.",
